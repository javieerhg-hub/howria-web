...
const TODOS_LOS_TABS = [
  ...
  { id: "pagos", label: "Pago trabajadores" },
  { id: "coordinacion", label: "Coordinación" },
  { id: "asignaciones", label: "Asignaciones" },
  { id: "mapa", label: "Mapa" },
  { id: "ingreso-personal", label: "Ingreso personal nuevo" },
...
export default function HowriaAdmin() {
  ...
  useEffect(() => {
    if (permisosRoles && !tabsPermitidosRol.includes(tab)) {
      setTab(tabsPermitidosRol[0] || "inicio");
    }
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM_SOFT, fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <div className="howria-main" style={{ padding: "28px 32px", maxWidth: 1040, margin: "0 auto" }}>
        ...
        {tab === "asignaciones" && tabsPermitidosRol.includes("asignaciones") && <Asignaciones clientes={clientes} setClientes={setClientes} usuarios={usuarios} />}
