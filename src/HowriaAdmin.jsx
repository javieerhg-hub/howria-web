...
const TODOS_LOS_TABS = [
  ...
  { id: "asignaciones", label: "Asignaciones", grupo: "Trabajo diario" },
...
function PortalCliente({ cliente, boletasCliente, onSalir }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM_SOFT, fontFamily: "'Inter', 'Helvetica Neue', Arial, sans-serif" }}>
...
export default function HowriaAdmin() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM_SOFT, fontFamily: "'Inter', 'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <div className="howria-tabs-desktop" style={{ position: "relative", display: "flex", gap: 4, padding: "0 32px", background: "#FFFFFF", borderBottom: "1px solid #EDE4CE", overflowX: "auto", WebkitOverflowScrolling: "touch" }}
