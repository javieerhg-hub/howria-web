...
export default function HowriaAdmin() {
  ...
  const tabs = esPaseador
    ...
    : [
        ...
        ...(puedeVerFinanzas ? [{ id: "coordinacion", label: "Coordinación" }] : []),
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM_SOFT, fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <div className="howria-main" style={{ padding: "28px 32px", maxWidth: 1040, margin: "0 auto" }}>
        ...
        {tab === "coordinacion" && puedeVerFinanzas && <Coordinacion clientes={clientes} setClientes={setClientes} usuarios={usuarios} registroPaseos={registroPaseos} setRegistroPaseos={setRegistroPaseos} />}
