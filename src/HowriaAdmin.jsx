  ...
  return (
    <div style={{ minHeight: "100vh", background: PANEL_BG, fontFamily: "'Inter', 'Helvetica Neue', Arial, sans-serif" }}>
      <style>{`
        * { -webkit-tap-highlight-color: transparent; -webkit-overflow-scrolling: touch; }
        ...
        @media (max-width: 680px) {
          ...
          /* Entró / Salió / Queda: en el celular una debajo de otra. Son
             las tres cifras que se leen de un vistazo y apretadas en tres
             columnas el monto queda ilegible. */
      ...
      <LimiteDeError onVolver={() => setTab("inicio")}>
        ...
        {tab === "finanzas" && tabsPermitidosRol.includes("finanzas") && <Finanzas boletasEmitidas={boletasEmitidas} boletasAdiestramiento={boletasAdiestramiento} clientes={clientes} citasAgenda={citasAgenda} pagosRegistrados={pagosRegistrados} registroPaseos={registroPaseos} reprogramaciones={reprogramaciones} costosNegocio={costosNegocio} setCostosNegocio={setCostosNegocio} nombreUsuario={user.nombre} user={user} onVerPagos={tabsPermitidosRol.includes("pagos") ? () => setTab("pagos") : undefined} onVerBoletas={tabsPermitidosRol.includes("boletas") ? () => setTab("boletas") : undefined} />}
