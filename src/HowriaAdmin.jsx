  ...
  return (
    <div style={{ minHeight: "100vh", background: PANEL_BG, fontFamily: "'Inter', 'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <LimiteDeError key={tab} onVolver={() => setTab("inicio")}>
        ...
        {tab === "calendario" && tabsPermitidosRol.includes("calendario") && <CalendarioAlumnos citasAgenda={citasAgenda} setCitas={setCitasAgenda} clientes={clientes} registroPaseos={registroPaseos} rolActual={user.rol} nombreActual={user.nombre} />}
