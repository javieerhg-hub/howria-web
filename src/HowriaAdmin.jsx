...
function PanelAdmin({ usuarios, setUsuarios, clientes, usuarioActual }) {
  const [busqueda, setBusqueda] = useState("");
  const [editandoId, setEditandoId] = useState(null);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="howria-card" style={tarjeta}>
        <h2 style={sectionTitle}>Qué puede hacer cada rol</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
          <div style={{ padding: 14, background: CREAM_SOFT, borderRadius: 8 }}>
            <p style={{ margin: "0 0 6px", fontWeight: 700, color: NAVY }}>Entrenador</p>
            <p style={{ margin: 0, fontSize: 13, color: "#6B6248", lineHeight: 1.5 }}>Solo ve "Mis paseos": sus clientes asignados y marca los paseos del día.</p>
          </div>
          <div style={{ padding: 14, background: CREAM_SOFT, borderRadius: 8 }}>
            <p style={{ margin: "0 0 6px", fontWeight: 700, color: NAVY }}>Coordinador</p>
            <p style={{ margin: 0, fontSize: 13, color: "#6B6248", lineHeight: 1.5 }}>Ve todo: clientes, boletas, finanzas, equipo, agenda y prospectos. No puede eliminar clientes ni gestionar usuarios.</p>
          </div>
          <div style={{ padding: 14, background: CREAM_SOFT, borderRadius: 8 }}>
            <p style={{ margin: "0 0 6px", fontWeight: 700, color: NAVY }}>Administrador general</p>
            <p style={{ margin: 0, fontSize: 13, color: "#6B6248", lineHeight: 1.5 }}>Acceso total: además de todo lo anterior, puede eliminar clientes, dar de alta personal nuevo y gestionar usuarios.</p>
          </div>
        </div>
      </div>
      ...
      <div className="howria-card" style={tarjeta}>
        ...
        <p style={{ fontSize: 12, color: "#8A7E5C", marginTop: 14, lineHeight: 1.5 }}>
          Nota: eliminar aquí quita el acceso de esta persona a la app, pero su cuenta de acceso sigue existiendo en Supabase → Authentication → Users — bórrala también ahí si quieres cerrarla por completo. Para restablecer una contraseña, hazlo desde esa misma pantalla de Supabase.
        </p>
      </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: CREAM_SOFT, fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      <div className="howria-main" style={{ padding: "28px 32px", maxWidth: 1040, margin: "0 auto" }}>
        ...
        {tab === "usuarios" && esAdmin && <PanelAdmin usuarios={usuarios} setUsuarios={setUsuarios} clientes={clientes} usuarioActual={user} />}
      </div>
    </div>
  );
}
